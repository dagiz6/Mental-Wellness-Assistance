  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hello! I'm MindMate, your AI wellness assistant. I'm here to listen, provide support, and offer guidance for your mental health journey. How are you feeling today?",
      timestamp: new Date(),
    },
  ]);
      ...
      <header className="sticky top-0 border-b border-border bg-background/80 backdrop-blur-sm z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-foreground">MindMate Assistant</h1>
      ...
      <footer className="border-t border-border bg-background/80 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-6 py-6">
          ...
          <p className="text-xs text-muted-foreground text-center mt-3">
            MindMate can make mistakes. Always consult a healthcare professional for medical advice.
          </p>
        </div>
      </footer>
    </div>
